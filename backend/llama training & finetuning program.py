...
print(f"✅ Loaded {len(raw_data)} cases from MANISH.json.")
...
print("✅ Created training texts for", len(training_texts), "cases.")
print("📌 Sample training text (first 500 characters):\n", training_texts[0][:500])
print("-" * 80)
...
print("✅ Hugging Face dataset created with", len(hf_dataset), "examples.")
...
print("✅ Tokenization complete. Using max_length =", max_context_length)
...
print(f"💾 Model state_dict saved as .pkl at: {save_path}")
